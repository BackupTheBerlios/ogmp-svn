...
#define XTHREAD_NONEFLAGS 0 
 ...
 xrtp_thread_t * xthr_new(int (*fn)(void *), void *, int flag);

 int xthr_wait(xrtp_thread_t * anoth, void *ret_anoth);

 int xthr_cancel(xrtp_thread_t * anoth);
 ...
 int xthr_cond_wait_timeout(xthr_cond_t * cond, xthr_lock_t * lock, uint32 time);
