...
/* =============== all old api still exist for compatibility ================= */
...
/* this api is replaced by 'time_rightnow()' */
...
int time_passed(xrtp_clock_t * clock, int lrts_then, int hrts_then, int *lrt_passed, int *hrt_passed){
...
int lrtime_now(xrtp_clock_t * clock){
